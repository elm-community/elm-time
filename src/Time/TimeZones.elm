...
africa_abidjan = africa_abidjan_l

{-| Africa/Accra -}
africa_accra : TimeZone
africa_accra = africa_accra_l

{-| Africa/Addis_Ababa -}
africa_addis_ababa : TimeZone
africa_addis_ababa = link "Africa/Addis_Ababa" africa_nairobi_l

{-| Africa/Algiers -}
africa_algiers : TimeZone
africa_algiers = africa_algiers_l

{-| Africa/Asmara -}
africa_asmara : TimeZone
africa_asmara = link "Africa/Asmara" africa_nairobi_l

{-| Africa/Asmera -}
africa_asmera : TimeZone
africa_asmera = link "Africa/Asmera" africa_nairobi_l

{-| Africa/Bamako -}
africa_bamako : TimeZone
africa_bamako = link "Africa/Bamako" africa_abidjan_l

{-| Africa/Bangui -}
africa_bangui : TimeZone
africa_bangui = link "Africa/Bangui" africa_lagos_l

{-| Africa/Banjul -}
africa_banjul : TimeZone
africa_banjul = link "Africa/Banjul" africa_abidjan_l

{-| Africa/Bissau -}
africa_bissau : TimeZone
africa_bissau = africa_bissau_l

{-| Africa/Blantyre -}
africa_blantyre : TimeZone
africa_blantyre = link "Africa/Blantyre" africa_maputo_l

{-| Africa/Brazzaville -}
africa_brazzaville : TimeZone
africa_brazzaville = link "Africa/Brazzaville" africa_lagos_l

{-| Africa/Bujumbura -}
africa_bujumbura : TimeZone
africa_bujumbura = link "Africa/Bujumbura" africa_maputo_l

{-| Africa/Cairo -}
africa_cairo : TimeZone
africa_cairo = africa_cairo_l

{-| Africa/Casablanca -}
africa_casablanca : TimeZone
africa_casablanca = africa_casablanca_l

{-| Africa/Ceuta -}
africa_ceuta : TimeZone
africa_ceuta = africa_ceuta_l

{-| Africa/Conakry -}
africa_conakry : TimeZone
africa_conakry = link "Africa/Conakry" africa_abidjan_l

{-| Africa/Dakar -}
africa_dakar : TimeZone
africa_dakar = link "Africa/Dakar" africa_abidjan_l

{-| Africa/Dar_es_Salaam -}
africa_dar_es_salaam : TimeZone
africa_dar_es_salaam = link "Africa/Dar_es_Salaam" africa_nairobi_l

{-| Africa/Djibouti -}
africa_djibouti : TimeZone
africa_djibouti = link "Africa/Djibouti" africa_nairobi_l

{-| Africa/Douala -}
africa_douala : TimeZone
africa_douala = link "Africa/Douala" africa_lagos_l

{-| Africa/El_Aaiun -}
africa_el_aaiun : TimeZone
africa_el_aaiun = africa_el_aaiun_l

{-| Africa/Freetown -}
africa_freetown : TimeZone
africa_freetown = link "Africa/Freetown" africa_abidjan_l

{-| Africa/Gaborone -}
africa_gaborone : TimeZone
africa_gaborone = link "Africa/Gaborone" africa_maputo_l

{-| Africa/Harare -}
africa_harare : TimeZone
africa_harare = link "Africa/Harare" africa_maputo_l

{-| Africa/Johannesburg -}
africa_johannesburg : TimeZone
africa_johannesburg = africa_johannesburg_l

{-| Africa/Juba -}
africa_juba : TimeZone
africa_juba = link "Africa/Juba" africa_khartoum_l

{-| Africa/Kampala -}
africa_kampala : TimeZone
africa_kampala = link "Africa/Kampala" africa_nairobi_l

{-| Africa/Khartoum -}
africa_khartoum : TimeZone
africa_khartoum = africa_khartoum_l

{-| Africa/Kigali -}
africa_kigali : TimeZone
africa_kigali = link "Africa/Kigali" africa_maputo_l

{-| Africa/Kinshasa -}
africa_kinshasa : TimeZone
africa_kinshasa = link "Africa/Kinshasa" africa_lagos_l

{-| Africa/Lagos -}
africa_lagos : TimeZone
africa_lagos = africa_lagos_l

{-| Africa/Libreville -}
africa_libreville : TimeZone
africa_libreville = link "Africa/Libreville" africa_lagos_l

{-| Africa/Lome -}
africa_lome : TimeZone
africa_lome = link "Africa/Lome" africa_abidjan_l

{-| Africa/Luanda -}
africa_luanda : TimeZone
africa_luanda = link "Africa/Luanda" africa_lagos_l

{-| Africa/Lubumbashi -}
africa_lubumbashi : TimeZone
africa_lubumbashi = link "Africa/Lubumbashi" africa_maputo_l

{-| Africa/Lusaka -}
africa_lusaka : TimeZone
africa_lusaka = link "Africa/Lusaka" africa_maputo_l

{-| Africa/Malabo -}
africa_malabo : TimeZone
africa_malabo = link "Africa/Malabo" africa_lagos_l

{-| Africa/Maputo -}
africa_maputo : TimeZone
africa_maputo = africa_maputo_l

{-| Africa/Maseru -}
africa_maseru : TimeZone
africa_maseru = link "Africa/Maseru" africa_johannesburg_l

{-| Africa/Mbabane -}
africa_mbabane : TimeZone
africa_mbabane = link "Africa/Mbabane" africa_johannesburg_l

{-| Africa/Mogadishu -}
africa_mogadishu : TimeZone
africa_mogadishu = link "Africa/Mogadishu" africa_nairobi_l

{-| Africa/Monrovia -}
africa_monrovia : TimeZone
africa_monrovia = africa_monrovia_l

{-| Africa/Nairobi -}
africa_nairobi : TimeZone
africa_nairobi = africa_nairobi_l

{-| Africa/Ndjamena -}
africa_ndjamena : TimeZone
africa_ndjamena = africa_ndjamena_l

{-| Africa/Niamey -}
africa_niamey : TimeZone
africa_niamey = link "Africa/Niamey" africa_lagos_l

{-| Africa/Nouakchott -}
africa_nouakchott : TimeZone
africa_nouakchott = link "Africa/Nouakchott" africa_abidjan_l

{-| Africa/Ouagadougou -}
africa_ouagadougou : TimeZone
africa_ouagadougou = link "Africa/Ouagadougou" africa_abidjan_l

{-| Africa/Porto-Novo -}
africa_porto_novo : TimeZone
africa_porto_novo = link "Africa/Porto-Novo" africa_lagos_l

{-| Africa/Sao_Tome -}
africa_sao_tome : TimeZone
africa_sao_tome = link "Africa/Sao_Tome" africa_abidjan_l

{-| Africa/Timbuktu -}
africa_timbuktu : TimeZone
africa_timbuktu = link "Africa/Timbuktu" africa_abidjan_l

{-| Africa/Tripoli -}
africa_tripoli : TimeZone
africa_tripoli = africa_tripoli_l

{-| Africa/Tunis -}
africa_tunis : TimeZone
africa_tunis = africa_tunis_l

{-| Africa/Windhoek -}
africa_windhoek : TimeZone
africa_windhoek = africa_windhoek_l

{-| America/Adak -}
america_adak : TimeZone
america_adak = america_adak_l

{-| America/Anchorage -}
america_anchorage : TimeZone
america_anchorage = america_anchorage_l

{-| America/Anguilla -}
america_anguilla : TimeZone
america_anguilla = link "America/Anguilla" america_port_of_spain_l

{-| America/Antigua -}
america_antigua : TimeZone
america_antigua = link "America/Antigua" america_port_of_spain_l

{-| America/Araguaina -}
america_araguaina : TimeZone
america_araguaina = america_araguaina_l

{-| America/Argentina/Buenos_Aires -}
america_argentina_buenos_aires : TimeZone
america_argentina_buenos_aires = america_argentina_buenos_aires_l

{-| America/Argentina/Catamarca -}
america_argentina_catamarca : TimeZone
america_argentina_catamarca = america_argentina_catamarca_l

{-| America/Argentina/ComodRivadavia -}
america_argentina_comodrivadavia : TimeZone
america_argentina_comodrivadavia = link "America/Argentina/ComodRivadavia" america_argentina_catamarca_l

{-| America/Argentina/Cordoba -}
america_argentina_cordoba : TimeZone
america_argentina_cordoba = america_argentina_cordoba_l

{-| America/Argentina/Jujuy -}
america_argentina_jujuy : TimeZone
america_argentina_jujuy = america_argentina_jujuy_l

{-| America/Argentina/La_Rioja -}
america_argentina_la_rioja : TimeZone
america_argentina_la_rioja = america_argentina_la_rioja_l

{-| America/Argentina/Mendoza -}
america_argentina_mendoza : TimeZone
america_argentina_mendoza = america_argentina_mendoza_l

{-| America/Argentina/Rio_Gallegos -}
america_argentina_rio_gallegos : TimeZone
america_argentina_rio_gallegos = america_argentina_rio_gallegos_l

{-| America/Argentina/Salta -}
america_argentina_salta : TimeZone
america_argentina_salta = america_argentina_salta_l

{-| America/Argentina/San_Juan -}
america_argentina_san_juan : TimeZone
america_argentina_san_juan = america_argentina_san_juan_l

{-| America/Argentina/San_Luis -}
america_argentina_san_luis : TimeZone
america_argentina_san_luis = america_argentina_san_luis_l

{-| America/Argentina/Tucuman -}
america_argentina_tucuman : TimeZone
america_argentina_tucuman = america_argentina_tucuman_l

{-| America/Argentina/Ushuaia -}
america_argentina_ushuaia : TimeZone
america_argentina_ushuaia = america_argentina_ushuaia_l

{-| America/Aruba -}
america_aruba : TimeZone
america_aruba = link "America/Aruba" america_curacao_l

{-| America/Asuncion -}
america_asuncion : TimeZone
america_asuncion = america_asuncion_l

{-| America/Atikokan -}
america_atikokan : TimeZone
america_atikokan = america_atikokan_l

{-| America/Atka -}
america_atka : TimeZone
america_atka = link "America/Atka" america_adak_l

{-| America/Bahia -}
america_bahia : TimeZone
america_bahia = america_bahia_l

{-| America/Bahia_Banderas -}
america_bahia_banderas : TimeZone
america_bahia_banderas = america_bahia_banderas_l

{-| America/Barbados -}
america_barbados : TimeZone
america_barbados = america_barbados_l

{-| America/Belem -}
america_belem : TimeZone
america_belem = america_belem_l

{-| America/Belize -}
america_belize : TimeZone
america_belize = america_belize_l

{-| America/Blanc-Sablon -}
america_blanc_sablon : TimeZone
america_blanc_sablon = america_blanc_sablon_l

{-| America/Boa_Vista -}
america_boa_vista : TimeZone
america_boa_vista = america_boa_vista_l

{-| America/Bogota -}
america_bogota : TimeZone
america_bogota = america_bogota_l

{-| America/Boise -}
america_boise : TimeZone
america_boise = america_boise_l

{-| America/Buenos_Aires -}
america_buenos_aires : TimeZone
america_buenos_aires = link "America/Buenos_Aires" america_argentina_buenos_aires_l

{-| America/Cambridge_Bay -}
america_cambridge_bay : TimeZone
america_cambridge_bay = america_cambridge_bay_l

{-| America/Campo_Grande -}
america_campo_grande : TimeZone
america_campo_grande = america_campo_grande_l

{-| America/Cancun -}
america_cancun : TimeZone
america_cancun = america_cancun_l

{-| America/Caracas -}
america_caracas : TimeZone
america_caracas = america_caracas_l

{-| America/Catamarca -}
america_catamarca : TimeZone
america_catamarca = link "America/Catamarca" america_argentina_catamarca_l

{-| America/Cayenne -}
america_cayenne : TimeZone
america_cayenne = america_cayenne_l

{-| America/Cayman -}
america_cayman : TimeZone
america_cayman = link "America/Cayman" america_panama_l

{-| America/Chicago -}
america_chicago : TimeZone
america_chicago = america_chicago_l

{-| America/Chihuahua -}
america_chihuahua : TimeZone
america_chihuahua = america_chihuahua_l

{-| America/Coral_Harbour -}
america_coral_harbour : TimeZone
america_coral_harbour = link "America/Coral_Harbour" america_atikokan_l

{-| America/Cordoba -}
america_cordoba : TimeZone
america_cordoba = link "America/Cordoba" america_argentina_cordoba_l

{-| America/Costa_Rica -}
america_costa_rica : TimeZone
america_costa_rica = america_costa_rica_l

{-| America/Creston -}
america_creston : TimeZone
america_creston = america_creston_l

{-| America/Cuiaba -}
america_cuiaba : TimeZone
america_cuiaba = america_cuiaba_l

{-| America/Curacao -}
america_curacao : TimeZone
america_curacao = america_curacao_l

{-| America/Danmarkshavn -}
america_danmarkshavn : TimeZone
america_danmarkshavn = america_danmarkshavn_l

{-| America/Dawson -}
america_dawson : TimeZone
america_dawson = america_dawson_l

{-| America/Dawson_Creek -}
america_dawson_creek : TimeZone
america_dawson_creek = america_dawson_creek_l

{-| America/Denver -}
america_denver : TimeZone
america_denver = america_denver_l

{-| America/Detroit -}
america_detroit : TimeZone
america_detroit = america_detroit_l

{-| America/Dominica -}
america_dominica : TimeZone
america_dominica = link "America/Dominica" america_port_of_spain_l

{-| America/Edmonton -}
america_edmonton : TimeZone
america_edmonton = america_edmonton_l

{-| America/Eirunepe -}
america_eirunepe : TimeZone
america_eirunepe = america_eirunepe_l

{-| America/El_Salvador -}
america_el_salvador : TimeZone
america_el_salvador = america_el_salvador_l

{-| America/Ensenada -}
america_ensenada : TimeZone
america_ensenada = link "America/Ensenada" america_tijuana_l

{-| America/Fort_Nelson -}
america_fort_nelson : TimeZone
america_fort_nelson = america_fort_nelson_l

{-| America/Fort_Wayne -}
america_fort_wayne : TimeZone
america_fort_wayne = america_fort_wayne_l

{-| America/Fortaleza -}
america_fortaleza : TimeZone
america_fortaleza = america_fortaleza_l

{-| America/Glace_Bay -}
america_glace_bay : TimeZone
america_glace_bay = america_glace_bay_l

{-| America/Godthab -}
america_godthab : TimeZone
america_godthab = america_godthab_l

{-| America/Goose_Bay -}
america_goose_bay : TimeZone
america_goose_bay = america_goose_bay_l

{-| America/Grand_Turk -}
america_grand_turk : TimeZone
america_grand_turk = america_grand_turk_l

{-| America/Grenada -}
america_grenada : TimeZone
america_grenada = link "America/Grenada" america_port_of_spain_l

{-| America/Guadeloupe -}
america_guadeloupe : TimeZone
america_guadeloupe = link "America/Guadeloupe" america_port_of_spain_l

{-| America/Guatemala -}
america_guatemala : TimeZone
america_guatemala = america_guatemala_l

{-| America/Guayaquil -}
america_guayaquil : TimeZone
america_guayaquil = america_guayaquil_l

{-| America/Guyana -}
america_guyana : TimeZone
america_guyana = america_guyana_l

{-| America/Halifax -}
america_halifax : TimeZone
america_halifax = america_halifax_l

{-| America/Havana -}
america_havana : TimeZone
america_havana = america_havana_l

{-| America/Hermosillo -}
america_hermosillo : TimeZone
america_hermosillo = america_hermosillo_l

{-| America/Indiana/Indianapolis -}
america_indiana_indianapolis : TimeZone
america_indiana_indianapolis = link "America/Indiana/Indianapolis" america_fort_wayne_l

{-| America/Indiana/Knox -}
america_indiana_knox : TimeZone
america_indiana_knox = america_indiana_knox_l

{-| America/Indiana/Marengo -}
america_indiana_marengo : TimeZone
america_indiana_marengo = america_indiana_marengo_l

{-| America/Indiana/Petersburg -}
america_indiana_petersburg : TimeZone
america_indiana_petersburg = america_indiana_petersburg_l

{-| America/Indiana/Tell_City -}
america_indiana_tell_city : TimeZone
america_indiana_tell_city = america_indiana_tell_city_l

{-| America/Indiana/Vevay -}
america_indiana_vevay : TimeZone
america_indiana_vevay = america_indiana_vevay_l

{-| America/Indiana/Vincennes -}
america_indiana_vincennes : TimeZone
america_indiana_vincennes = america_indiana_vincennes_l

{-| America/Indiana/Winamac -}
america_indiana_winamac : TimeZone
america_indiana_winamac = america_indiana_winamac_l

{-| America/Indianapolis -}
america_indianapolis : TimeZone
america_indianapolis = link "America/Indianapolis" america_fort_wayne_l

{-| America/Inuvik -}
america_inuvik : TimeZone
america_inuvik = america_inuvik_l

{-| America/Iqaluit -}
america_iqaluit : TimeZone
america_iqaluit = america_iqaluit_l

{-| America/Jamaica -}
america_jamaica : TimeZone
america_jamaica = america_jamaica_l

{-| America/Jujuy -}
america_jujuy : TimeZone
america_jujuy = link "America/Jujuy" america_argentina_jujuy_l

{-| America/Juneau -}
america_juneau : TimeZone
america_juneau = america_juneau_l

{-| America/Kentucky/Louisville -}
america_kentucky_louisville : TimeZone
america_kentucky_louisville = america_kentucky_louisville_l

{-| America/Kentucky/Monticello -}
america_kentucky_monticello : TimeZone
america_kentucky_monticello = america_kentucky_monticello_l

{-| America/Knox_IN -}
america_knox_in : TimeZone
america_knox_in = link "America/Knox_IN" america_indiana_knox_l

{-| America/Kralendijk -}
america_kralendijk : TimeZone
america_kralendijk = link "America/Kralendijk" america_curacao_l

{-| America/La_Paz -}
america_la_paz : TimeZone
america_la_paz = america_la_paz_l

{-| America/Lima -}
america_lima : TimeZone
america_lima = america_lima_l

{-| America/Los_Angeles -}
america_los_angeles : TimeZone
america_los_angeles = america_los_angeles_l

{-| America/Louisville -}
america_louisville : TimeZone
america_louisville = link "America/Louisville" america_kentucky_louisville_l

{-| America/Lower_Princes -}
america_lower_princes : TimeZone
america_lower_princes = link "America/Lower_Princes" america_curacao_l

{-| America/Maceio -}
america_maceio : TimeZone
america_maceio = america_maceio_l

{-| America/Managua -}
america_managua : TimeZone
america_managua = america_managua_l

{-| America/Manaus -}
america_manaus : TimeZone
america_manaus = america_manaus_l

{-| America/Marigot -}
america_marigot : TimeZone
america_marigot = link "America/Marigot" america_port_of_spain_l

{-| America/Martinique -}
america_martinique : TimeZone
america_martinique = america_martinique_l

{-| America/Matamoros -}
america_matamoros : TimeZone
america_matamoros = america_matamoros_l

{-| America/Mazatlan -}
america_mazatlan : TimeZone
america_mazatlan = america_mazatlan_l

{-| America/Mendoza -}
america_mendoza : TimeZone
america_mendoza = link "America/Mendoza" america_argentina_mendoza_l

{-| America/Menominee -}
america_menominee : TimeZone
america_menominee = america_menominee_l

{-| America/Merida -}
america_merida : TimeZone
america_merida = america_merida_l

{-| America/Metlakatla -}
america_metlakatla : TimeZone
america_metlakatla = america_metlakatla_l

{-| America/Mexico_City -}
america_mexico_city : TimeZone
america_mexico_city = america_mexico_city_l

{-| America/Miquelon -}
america_miquelon : TimeZone
america_miquelon = america_miquelon_l

{-| America/Moncton -}
america_moncton : TimeZone
america_moncton = america_moncton_l

{-| America/Monterrey -}
america_monterrey : TimeZone
america_monterrey = america_monterrey_l

{-| America/Montevideo -}
america_montevideo : TimeZone
america_montevideo = america_montevideo_l

{-| America/Montreal -}
america_montreal : TimeZone
america_montreal = link "America/Montreal" america_toronto_l

{-| America/Montserrat -}
america_montserrat : TimeZone
america_montserrat = link "America/Montserrat" america_port_of_spain_l

{-| America/Nassau -}
america_nassau : TimeZone
america_nassau = america_nassau_l

{-| America/New_York -}
america_new_york : TimeZone
america_new_york = america_new_york_l

{-| America/Nipigon -}
america_nipigon : TimeZone
america_nipigon = america_nipigon_l

{-| America/Nome -}
america_nome : TimeZone
america_nome = america_nome_l

{-| America/Noronha -}
america_noronha : TimeZone
america_noronha = america_noronha_l

{-| America/North_Dakota/Beulah -}
america_north_dakota_beulah : TimeZone
america_north_dakota_beulah = america_north_dakota_beulah_l

{-| America/North_Dakota/Center -}
america_north_dakota_center : TimeZone
america_north_dakota_center = america_north_dakota_center_l

{-| America/North_Dakota/New_Salem -}
america_north_dakota_new_salem : TimeZone
america_north_dakota_new_salem = america_north_dakota_new_salem_l

{-| America/Ojinaga -}
america_ojinaga : TimeZone
america_ojinaga = america_ojinaga_l

{-| America/Panama -}
america_panama : TimeZone
america_panama = america_panama_l

{-| America/Pangnirtung -}
america_pangnirtung : TimeZone
america_pangnirtung = america_pangnirtung_l

{-| America/Paramaribo -}
america_paramaribo : TimeZone
america_paramaribo = america_paramaribo_l

{-| America/Phoenix -}
america_phoenix : TimeZone
america_phoenix = america_phoenix_l

{-| America/Port-au-Prince -}
america_port_au_prince : TimeZone
america_port_au_prince = america_port_au_prince_l

{-| America/Port_of_Spain -}
america_port_of_spain : TimeZone
america_port_of_spain = america_port_of_spain_l

{-| America/Porto_Acre -}
america_porto_acre : TimeZone
america_porto_acre = link "America/Porto_Acre" america_rio_branco_l

{-| America/Porto_Velho -}
america_porto_velho : TimeZone
america_porto_velho = america_porto_velho_l

{-| America/Puerto_Rico -}
america_puerto_rico : TimeZone
america_puerto_rico = america_puerto_rico_l

{-| America/Rainy_River -}
america_rainy_river : TimeZone
america_rainy_river = america_rainy_river_l

{-| America/Rankin_Inlet -}
america_rankin_inlet : TimeZone
america_rankin_inlet = america_rankin_inlet_l

{-| America/Recife -}
america_recife : TimeZone
america_recife = america_recife_l

{-| America/Regina -}
america_regina : TimeZone
america_regina = america_regina_l

{-| America/Resolute -}
america_resolute : TimeZone
america_resolute = america_resolute_l

{-| America/Rio_Branco -}
america_rio_branco : TimeZone
america_rio_branco = america_rio_branco_l

{-| America/Rosario -}
america_rosario : TimeZone
america_rosario = link "America/Rosario" america_argentina_cordoba_l

{-| America/Santa_Isabel -}
america_santa_isabel : TimeZone
america_santa_isabel = link "America/Santa_Isabel" america_tijuana_l

{-| America/Santarem -}
america_santarem : TimeZone
america_santarem = america_santarem_l

{-| America/Santiago -}
america_santiago : TimeZone
america_santiago = america_santiago_l

{-| America/Santo_Domingo -}
america_santo_domingo : TimeZone
america_santo_domingo = america_santo_domingo_l

{-| America/Sao_Paulo -}
america_sao_paulo : TimeZone
america_sao_paulo = america_sao_paulo_l

{-| America/Scoresbysund -}
america_scoresbysund : TimeZone
america_scoresbysund = america_scoresbysund_l

{-| America/Shiprock -}
america_shiprock : TimeZone
america_shiprock = link "America/Shiprock" america_denver_l

{-| America/Sitka -}
america_sitka : TimeZone
america_sitka = america_sitka_l

{-| America/St_Barthelemy -}
america_st_barthelemy : TimeZone
america_st_barthelemy = link "America/St_Barthelemy" america_port_of_spain_l

{-| America/St_Johns -}
america_st_johns : TimeZone
america_st_johns = america_st_johns_l

{-| America/St_Kitts -}
america_st_kitts : TimeZone
america_st_kitts = link "America/St_Kitts" america_port_of_spain_l

{-| America/St_Lucia -}
america_st_lucia : TimeZone
america_st_lucia = link "America/St_Lucia" america_port_of_spain_l

{-| America/St_Thomas -}
america_st_thomas : TimeZone
america_st_thomas = link "America/St_Thomas" america_port_of_spain_l

{-| America/St_Vincent -}
america_st_vincent : TimeZone
america_st_vincent = link "America/St_Vincent" america_port_of_spain_l

{-| America/Swift_Current -}
america_swift_current : TimeZone
america_swift_current = america_swift_current_l

{-| America/Tegucigalpa -}
america_tegucigalpa : TimeZone
america_tegucigalpa = america_tegucigalpa_l

{-| America/Thule -}
america_thule : TimeZone
america_thule = america_thule_l

{-| America/Thunder_Bay -}
america_thunder_bay : TimeZone
america_thunder_bay = america_thunder_bay_l

{-| America/Tijuana -}
america_tijuana : TimeZone
america_tijuana = america_tijuana_l

{-| America/Toronto -}
america_toronto : TimeZone
america_toronto = america_toronto_l

{-| America/Tortola -}
america_tortola : TimeZone
america_tortola = link "America/Tortola" america_port_of_spain_l

{-| America/Vancouver -}
america_vancouver : TimeZone
america_vancouver = america_vancouver_l

{-| America/Virgin -}
america_virgin : TimeZone
america_virgin = link "America/Virgin" america_port_of_spain_l

{-| America/Whitehorse -}
america_whitehorse : TimeZone
america_whitehorse = america_whitehorse_l

{-| America/Winnipeg -}
america_winnipeg : TimeZone
america_winnipeg = america_winnipeg_l

{-| America/Yakutat -}
america_yakutat : TimeZone
america_yakutat = america_yakutat_l

{-| America/Yellowknife -}
america_yellowknife : TimeZone
america_yellowknife = america_yellowknife_l

{-| Antarctica/Casey -}
antarctica_casey : TimeZone
antarctica_casey = antarctica_casey_l

{-| Antarctica/Davis -}
antarctica_davis : TimeZone
antarctica_davis = antarctica_davis_l

{-| Antarctica/DumontDUrville -}
antarctica_dumontdurville : TimeZone
antarctica_dumontdurville = antarctica_dumontdurville_l

{-| Antarctica/Macquarie -}
antarctica_macquarie : TimeZone
antarctica_macquarie = antarctica_macquarie_l

{-| Antarctica/Mawson -}
antarctica_mawson : TimeZone
antarctica_mawson = antarctica_mawson_l

{-| Antarctica/McMurdo -}
antarctica_mcmurdo : TimeZone
antarctica_mcmurdo = link "Antarctica/McMurdo" pacific_auckland_l

{-| Antarctica/Palmer -}
antarctica_palmer : TimeZone
antarctica_palmer = antarctica_palmer_l

{-| Antarctica/Rothera -}
antarctica_rothera : TimeZone
antarctica_rothera = antarctica_rothera_l

{-| Antarctica/South_Pole -}
antarctica_south_pole : TimeZone
antarctica_south_pole = link "Antarctica/South_Pole" pacific_auckland_l

{-| Antarctica/Syowa -}
antarctica_syowa : TimeZone
antarctica_syowa = antarctica_syowa_l

{-| Antarctica/Troll -}
antarctica_troll : TimeZone
antarctica_troll = antarctica_troll_l

{-| Antarctica/Vostok -}
antarctica_vostok : TimeZone
antarctica_vostok = antarctica_vostok_l

{-| Arctic/Longyearbyen -}
arctic_longyearbyen : TimeZone
arctic_longyearbyen = link "Arctic/Longyearbyen" europe_oslo_l

{-| Asia/Aden -}
asia_aden : TimeZone
asia_aden = link "Asia/Aden" asia_riyadh_l

{-| Asia/Almaty -}
asia_almaty : TimeZone
asia_almaty = asia_almaty_l

{-| Asia/Amman -}
asia_amman : TimeZone
asia_amman = asia_amman_l

{-| Asia/Anadyr -}
asia_anadyr : TimeZone
asia_anadyr = asia_anadyr_l

{-| Asia/Aqtau -}
asia_aqtau : TimeZone
asia_aqtau = asia_aqtau_l

{-| Asia/Aqtobe -}
asia_aqtobe : TimeZone
asia_aqtobe = asia_aqtobe_l

{-| Asia/Ashgabat -}
asia_ashgabat : TimeZone
asia_ashgabat = asia_ashgabat_l

{-| Asia/Ashkhabad -}
asia_ashkhabad : TimeZone
asia_ashkhabad = link "Asia/Ashkhabad" asia_ashgabat_l

{-| Asia/Baghdad -}
asia_baghdad : TimeZone
asia_baghdad = asia_baghdad_l

{-| Asia/Bahrain -}
asia_bahrain : TimeZone
asia_bahrain = link "Asia/Bahrain" asia_qatar_l

{-| Asia/Baku -}
asia_baku : TimeZone
asia_baku = asia_baku_l

{-| Asia/Bangkok -}
asia_bangkok : TimeZone
asia_bangkok = asia_bangkok_l

{-| Asia/Barnaul -}
asia_barnaul : TimeZone
asia_barnaul = asia_barnaul_l

{-| Asia/Beirut -}
asia_beirut : TimeZone
asia_beirut = asia_beirut_l

{-| Asia/Bishkek -}
asia_bishkek : TimeZone
asia_bishkek = asia_bishkek_l

{-| Asia/Brunei -}
asia_brunei : TimeZone
asia_brunei = asia_brunei_l

{-| Asia/Calcutta -}
asia_calcutta : TimeZone
asia_calcutta = link "Asia/Calcutta" asia_kolkata_l

{-| Asia/Chita -}
asia_chita : TimeZone
asia_chita = asia_chita_l

{-| Asia/Choibalsan -}
asia_choibalsan : TimeZone
asia_choibalsan = asia_choibalsan_l

{-| Asia/Chongqing -}
asia_chongqing : TimeZone
asia_chongqing = link "Asia/Chongqing" asia_shanghai_l

{-| Asia/Chungking -}
asia_chungking : TimeZone
asia_chungking = link "Asia/Chungking" asia_shanghai_l

{-| Asia/Colombo -}
asia_colombo : TimeZone
asia_colombo = asia_colombo_l

{-| Asia/Dacca -}
asia_dacca : TimeZone
asia_dacca = link "Asia/Dacca" asia_dhaka_l

{-| Asia/Damascus -}
asia_damascus : TimeZone
asia_damascus = asia_damascus_l

{-| Asia/Dhaka -}
asia_dhaka : TimeZone
asia_dhaka = asia_dhaka_l

{-| Asia/Dili -}
asia_dili : TimeZone
asia_dili = asia_dili_l

{-| Asia/Dubai -}
asia_dubai : TimeZone
asia_dubai = asia_dubai_l

{-| Asia/Dushanbe -}
asia_dushanbe : TimeZone
asia_dushanbe = asia_dushanbe_l

{-| Asia/Famagusta -}
asia_famagusta : TimeZone
asia_famagusta = asia_famagusta_l

{-| Asia/Gaza -}
asia_gaza : TimeZone
asia_gaza = asia_gaza_l

{-| Asia/Harbin -}
asia_harbin : TimeZone
asia_harbin = link "Asia/Harbin" asia_shanghai_l

{-| Asia/Hebron -}
asia_hebron : TimeZone
asia_hebron = asia_hebron_l

{-| Asia/Ho_Chi_Minh -}
asia_ho_chi_minh : TimeZone
asia_ho_chi_minh = asia_ho_chi_minh_l

{-| Asia/Hong_Kong -}
asia_hong_kong : TimeZone
asia_hong_kong = asia_hong_kong_l

{-| Asia/Hovd -}
asia_hovd : TimeZone
asia_hovd = asia_hovd_l

{-| Asia/Irkutsk -}
asia_irkutsk : TimeZone
asia_irkutsk = asia_irkutsk_l

{-| Asia/Istanbul -}
asia_istanbul : TimeZone
asia_istanbul = link "Asia/Istanbul" europe_istanbul_l

{-| Asia/Jakarta -}
asia_jakarta : TimeZone
asia_jakarta = asia_jakarta_l

{-| Asia/Jayapura -}
asia_jayapura : TimeZone
asia_jayapura = asia_jayapura_l

{-| Asia/Jerusalem -}
asia_jerusalem : TimeZone
asia_jerusalem = asia_jerusalem_l

{-| Asia/Kabul -}
asia_kabul : TimeZone
asia_kabul = asia_kabul_l

{-| Asia/Kamchatka -}
asia_kamchatka : TimeZone
asia_kamchatka = asia_kamchatka_l

{-| Asia/Karachi -}
asia_karachi : TimeZone
asia_karachi = asia_karachi_l

{-| Asia/Kashgar -}
asia_kashgar : TimeZone
asia_kashgar = link "Asia/Kashgar" asia_urumqi_l

{-| Asia/Kathmandu -}
asia_kathmandu : TimeZone
asia_kathmandu = asia_kathmandu_l

{-| Asia/Katmandu -}
asia_katmandu : TimeZone
asia_katmandu = link "Asia/Katmandu" asia_kathmandu_l

{-| Asia/Khandyga -}
asia_khandyga : TimeZone
asia_khandyga = asia_khandyga_l

{-| Asia/Kolkata -}
asia_kolkata : TimeZone
asia_kolkata = asia_kolkata_l

{-| Asia/Krasnoyarsk -}
asia_krasnoyarsk : TimeZone
asia_krasnoyarsk = asia_krasnoyarsk_l

{-| Asia/Kuala_Lumpur -}
asia_kuala_lumpur : TimeZone
asia_kuala_lumpur = asia_kuala_lumpur_l

{-| Asia/Kuching -}
asia_kuching : TimeZone
asia_kuching = asia_kuching_l

{-| Asia/Kuwait -}
asia_kuwait : TimeZone
asia_kuwait = link "Asia/Kuwait" asia_riyadh_l

{-| Asia/Macao -}
asia_macao : TimeZone
asia_macao = link "Asia/Macao" asia_macau_l

{-| Asia/Macau -}
asia_macau : TimeZone
asia_macau = asia_macau_l

{-| Asia/Magadan -}
asia_magadan : TimeZone
asia_magadan = asia_magadan_l

{-| Asia/Makassar -}
asia_makassar : TimeZone
asia_makassar = asia_makassar_l

{-| Asia/Manila -}
asia_manila : TimeZone
asia_manila = asia_manila_l

{-| Asia/Muscat -}
asia_muscat : TimeZone
asia_muscat = link "Asia/Muscat" asia_dubai_l

{-| Asia/Nicosia -}
asia_nicosia : TimeZone
asia_nicosia = asia_nicosia_l

{-| Asia/Novokuznetsk -}
asia_novokuznetsk : TimeZone
asia_novokuznetsk = asia_novokuznetsk_l

{-| Asia/Novosibirsk -}
asia_novosibirsk : TimeZone
asia_novosibirsk = asia_novosibirsk_l

{-| Asia/Omsk -}
asia_omsk : TimeZone
asia_omsk = asia_omsk_l

{-| Asia/Oral -}
asia_oral : TimeZone
asia_oral = asia_oral_l

{-| Asia/Phnom_Penh -}
asia_phnom_penh : TimeZone
asia_phnom_penh = link "Asia/Phnom_Penh" asia_bangkok_l

{-| Asia/Pontianak -}
asia_pontianak : TimeZone
asia_pontianak = asia_pontianak_l

{-| Asia/Pyongyang -}
asia_pyongyang : TimeZone
asia_pyongyang = asia_pyongyang_l

{-| Asia/Qatar -}
asia_qatar : TimeZone
asia_qatar = asia_qatar_l

{-| Asia/Qyzylorda -}
asia_qyzylorda : TimeZone
asia_qyzylorda = asia_qyzylorda_l

{-| Asia/Rangoon -}
asia_rangoon : TimeZone
asia_rangoon = asia_rangoon_l

{-| Asia/Riyadh -}
asia_riyadh : TimeZone
asia_riyadh = asia_riyadh_l

{-| Asia/Saigon -}
asia_saigon : TimeZone
asia_saigon = link "Asia/Saigon" asia_ho_chi_minh_l

{-| Asia/Sakhalin -}
asia_sakhalin : TimeZone
asia_sakhalin = asia_sakhalin_l

{-| Asia/Samarkand -}
asia_samarkand : TimeZone
asia_samarkand = asia_samarkand_l

{-| Asia/Seoul -}
asia_seoul : TimeZone
asia_seoul = asia_seoul_l

{-| Asia/Shanghai -}
asia_shanghai : TimeZone
asia_shanghai = asia_shanghai_l

{-| Asia/Singapore -}
asia_singapore : TimeZone
asia_singapore = asia_singapore_l

{-| Asia/Srednekolymsk -}
asia_srednekolymsk : TimeZone
asia_srednekolymsk = asia_srednekolymsk_l

{-| Asia/Taipei -}
asia_taipei : TimeZone
asia_taipei = asia_taipei_l

{-| Asia/Tashkent -}
asia_tashkent : TimeZone
asia_tashkent = asia_tashkent_l

{-| Asia/Tbilisi -}
asia_tbilisi : TimeZone
asia_tbilisi = asia_tbilisi_l

{-| Asia/Tehran -}
asia_tehran : TimeZone
asia_tehran = asia_tehran_l

{-| Asia/Tel_Aviv -}
asia_tel_aviv : TimeZone
asia_tel_aviv = link "Asia/Tel_Aviv" asia_jerusalem_l

{-| Asia/Thimbu -}
asia_thimbu : TimeZone
asia_thimbu = link "Asia/Thimbu" asia_thimphu_l

{-| Asia/Thimphu -}
asia_thimphu : TimeZone
asia_thimphu = asia_thimphu_l

{-| Asia/Tokyo -}
asia_tokyo : TimeZone
asia_tokyo = asia_tokyo_l

{-| Asia/Tomsk -}
asia_tomsk : TimeZone
asia_tomsk = asia_tomsk_l

{-| Asia/Ujung_Pandang -}
asia_ujung_pandang : TimeZone
asia_ujung_pandang = link "Asia/Ujung_Pandang" asia_makassar_l

{-| Asia/Ulaanbaatar -}
asia_ulaanbaatar : TimeZone
asia_ulaanbaatar = asia_ulaanbaatar_l

{-| Asia/Ulan_Bator -}
asia_ulan_bator : TimeZone
asia_ulan_bator = link "Asia/Ulan_Bator" asia_ulaanbaatar_l

{-| Asia/Urumqi -}
asia_urumqi : TimeZone
asia_urumqi = asia_urumqi_l

{-| Asia/Ust-Nera -}
asia_ust_nera : TimeZone
asia_ust_nera = asia_ust_nera_l

{-| Asia/Vientiane -}
asia_vientiane : TimeZone
asia_vientiane = link "Asia/Vientiane" asia_bangkok_l

{-| Asia/Vladivostok -}
asia_vladivostok : TimeZone
asia_vladivostok = asia_vladivostok_l

{-| Asia/Yakutsk -}
asia_yakutsk : TimeZone
asia_yakutsk = asia_yakutsk_l

{-| Asia/Yangon -}
asia_yangon : TimeZone
asia_yangon = link "Asia/Yangon" asia_rangoon_l

{-| Asia/Yekaterinburg -}
asia_yekaterinburg : TimeZone
asia_yekaterinburg = asia_yekaterinburg_l

{-| Asia/Yerevan -}
asia_yerevan : TimeZone
asia_yerevan = asia_yerevan_l

{-| Atlantic/Azores -}
atlantic_azores : TimeZone
atlantic_azores = atlantic_azores_l

{-| Atlantic/Bermuda -}
atlantic_bermuda : TimeZone
atlantic_bermuda = atlantic_bermuda_l

{-| Atlantic/Canary -}
atlantic_canary : TimeZone
atlantic_canary = atlantic_canary_l

{-| Atlantic/Cape_Verde -}
atlantic_cape_verde : TimeZone
atlantic_cape_verde = atlantic_cape_verde_l

{-| Atlantic/Faeroe -}
atlantic_faeroe : TimeZone
atlantic_faeroe = link "Atlantic/Faeroe" atlantic_faroe_l

{-| Atlantic/Faroe -}
atlantic_faroe : TimeZone
atlantic_faroe = atlantic_faroe_l

{-| Atlantic/Jan_Mayen -}
atlantic_jan_mayen : TimeZone
atlantic_jan_mayen = link "Atlantic/Jan_Mayen" europe_oslo_l

{-| Atlantic/Madeira -}
atlantic_madeira : TimeZone
atlantic_madeira = atlantic_madeira_l

{-| Atlantic/Reykjavik -}
atlantic_reykjavik : TimeZone
atlantic_reykjavik = atlantic_reykjavik_l

{-| Atlantic/South_Georgia -}
atlantic_south_georgia : TimeZone
atlantic_south_georgia = atlantic_south_georgia_l

{-| Atlantic/St_Helena -}
atlantic_st_helena : TimeZone
atlantic_st_helena = link "Atlantic/St_Helena" africa_abidjan_l

{-| Atlantic/Stanley -}
atlantic_stanley : TimeZone
atlantic_stanley = atlantic_stanley_l

{-| Australia/ACT -}
australia_act : TimeZone
australia_act = link "Australia/ACT" australia_sydney_l

{-| Australia/Adelaide -}
australia_adelaide : TimeZone
australia_adelaide = australia_adelaide_l

{-| Australia/Brisbane -}
australia_brisbane : TimeZone
australia_brisbane = australia_brisbane_l

{-| Australia/Broken_Hill -}
australia_broken_hill : TimeZone
australia_broken_hill = australia_broken_hill_l

{-| Australia/Canberra -}
australia_canberra : TimeZone
australia_canberra = link "Australia/Canberra" australia_sydney_l

{-| Australia/Currie -}
australia_currie : TimeZone
australia_currie = australia_currie_l

{-| Australia/Darwin -}
australia_darwin : TimeZone
australia_darwin = australia_darwin_l

{-| Australia/Eucla -}
australia_eucla : TimeZone
australia_eucla = australia_eucla_l

{-| Australia/Hobart -}
australia_hobart : TimeZone
australia_hobart = australia_hobart_l

{-| Australia/LHI -}
australia_lhi : TimeZone
australia_lhi = link "Australia/LHI" australia_lord_howe_l

{-| Australia/Lindeman -}
australia_lindeman : TimeZone
australia_lindeman = australia_lindeman_l

{-| Australia/Lord_Howe -}
australia_lord_howe : TimeZone
australia_lord_howe = australia_lord_howe_l

{-| Australia/Melbourne -}
australia_melbourne : TimeZone
australia_melbourne = australia_melbourne_l

{-| Australia/North -}
australia_north : TimeZone
australia_north = link "Australia/North" australia_darwin_l

{-| Australia/NSW -}
australia_nsw : TimeZone
australia_nsw = link "Australia/NSW" australia_sydney_l

{-| Australia/Perth -}
australia_perth : TimeZone
australia_perth = australia_perth_l

{-| Australia/Queensland -}
australia_queensland : TimeZone
australia_queensland = link "Australia/Queensland" australia_brisbane_l

{-| Australia/South -}
australia_south : TimeZone
australia_south = link "Australia/South" australia_adelaide_l

{-| Australia/Sydney -}
australia_sydney : TimeZone
australia_sydney = australia_sydney_l

{-| Australia/Tasmania -}
australia_tasmania : TimeZone
australia_tasmania = link "Australia/Tasmania" australia_hobart_l

{-| Australia/Victoria -}
australia_victoria : TimeZone
australia_victoria = link "Australia/Victoria" australia_melbourne_l

{-| Australia/West -}
australia_west : TimeZone
australia_west = link "Australia/West" australia_perth_l

{-| Australia/Yancowinna -}
australia_yancowinna : TimeZone
australia_yancowinna = link "Australia/Yancowinna" australia_broken_hill_l

{-| Brazil/Acre -}
brazil_acre : TimeZone
brazil_acre = link "Brazil/Acre" america_rio_branco_l

{-| Brazil/DeNoronha -}
brazil_denoronha : TimeZone
brazil_denoronha = link "Brazil/DeNoronha" america_noronha_l

{-| Brazil/East -}
brazil_east : TimeZone
brazil_east = link "Brazil/East" america_sao_paulo_l

{-| Brazil/West -}
brazil_west : TimeZone
brazil_west = link "Brazil/West" america_manaus_l

{-| Canada/Atlantic -}
canada_atlantic : TimeZone
canada_atlantic = link "Canada/Atlantic" america_halifax_l

{-| Canada/Central -}
canada_central : TimeZone
canada_central = link "Canada/Central" america_winnipeg_l

{-| Canada/East-Saskatchewan -}
canada_east_saskatchewan : TimeZone
canada_east_saskatchewan = link "Canada/East-Saskatchewan" america_regina_l

{-| Canada/Eastern -}
canada_eastern : TimeZone
canada_eastern = link "Canada/Eastern" america_toronto_l

{-| Canada/Mountain -}
canada_mountain : TimeZone
canada_mountain = link "Canada/Mountain" america_edmonton_l

{-| Canada/Newfoundland -}
canada_newfoundland : TimeZone
canada_newfoundland = link "Canada/Newfoundland" america_st_johns_l

{-| Canada/Pacific -}
canada_pacific : TimeZone
canada_pacific = link "Canada/Pacific" america_vancouver_l

{-| Canada/Saskatchewan -}
canada_saskatchewan : TimeZone
canada_saskatchewan = link "Canada/Saskatchewan" america_regina_l

{-| Canada/Yukon -}
canada_yukon : TimeZone
canada_yukon = link "Canada/Yukon" america_whitehorse_l
...
chile_continental = link "Chile/Continental" america_santiago_l

{-| Chile/EasterIsland -}
chile_easterisland : TimeZone
chile_easterisland = link "Chile/EasterIsland" pacific_easter_l
...
{-| Cuba -}
cuba : TimeZone
cuba = link "Cuba" america_havana_l
...
{-| Egypt -}
egypt : TimeZone
egypt = link "Egypt" africa_cairo_l

{-| Eire -}
eire : TimeZone
eire = link "Eire" europe_dublin_l
...
{-| Etc/GMT -}
etc_gmt : TimeZone
etc_gmt = link "Etc/GMT" etc_gmt_plus_0_l

{-| Etc/GMT0 -}
etc_gmt_0 : TimeZone
etc_gmt_0 = link "Etc/GMT0" etc_gmt_plus_0_l

{-| Etc/GMT-0 -}
etc_gmt_minus_0 : TimeZone
etc_gmt_minus_0 = link "Etc/GMT-0" etc_gmt_plus_0_l

{-| Etc/GMT-1 -}
etc_gmt_minus_1 : TimeZone
etc_gmt_minus_1 = etc_gmt_minus_1_l

{-| Etc/GMT-10 -}
etc_gmt_minus_10 : TimeZone
etc_gmt_minus_10 = etc_gmt_minus_10_l

{-| Etc/GMT-11 -}
etc_gmt_minus_11 : TimeZone
etc_gmt_minus_11 = etc_gmt_minus_11_l

{-| Etc/GMT-12 -}
etc_gmt_minus_12 : TimeZone
etc_gmt_minus_12 = etc_gmt_minus_12_l

{-| Etc/GMT-13 -}
etc_gmt_minus_13 : TimeZone
etc_gmt_minus_13 = etc_gmt_minus_13_l

{-| Etc/GMT-14 -}
etc_gmt_minus_14 : TimeZone
etc_gmt_minus_14 = etc_gmt_minus_14_l

{-| Etc/GMT-2 -}
etc_gmt_minus_2 : TimeZone
etc_gmt_minus_2 = etc_gmt_minus_2_l

{-| Etc/GMT-3 -}
etc_gmt_minus_3 : TimeZone
etc_gmt_minus_3 = etc_gmt_minus_3_l

{-| Etc/GMT-4 -}
etc_gmt_minus_4 : TimeZone
etc_gmt_minus_4 = etc_gmt_minus_4_l

{-| Etc/GMT-5 -}
etc_gmt_minus_5 : TimeZone
etc_gmt_minus_5 = etc_gmt_minus_5_l

{-| Etc/GMT-6 -}
etc_gmt_minus_6 : TimeZone
etc_gmt_minus_6 = etc_gmt_minus_6_l

{-| Etc/GMT-7 -}
etc_gmt_minus_7 : TimeZone
etc_gmt_minus_7 = etc_gmt_minus_7_l

{-| Etc/GMT-8 -}
etc_gmt_minus_8 : TimeZone
etc_gmt_minus_8 = etc_gmt_minus_8_l

{-| Etc/GMT-9 -}
etc_gmt_minus_9 : TimeZone
etc_gmt_minus_9 = etc_gmt_minus_9_l

{-| Etc/GMT+0 -}
etc_gmt_plus_0 : TimeZone
etc_gmt_plus_0 = etc_gmt_plus_0_l

{-| Etc/GMT+1 -}
etc_gmt_plus_1 : TimeZone
etc_gmt_plus_1 = etc_gmt_plus_1_l

{-| Etc/GMT+10 -}
etc_gmt_plus_10 : TimeZone
etc_gmt_plus_10 = etc_gmt_plus_10_l

{-| Etc/GMT+11 -}
etc_gmt_plus_11 : TimeZone
etc_gmt_plus_11 = etc_gmt_plus_11_l

{-| Etc/GMT+12 -}
etc_gmt_plus_12 : TimeZone
etc_gmt_plus_12 = etc_gmt_plus_12_l

{-| Etc/GMT+2 -}
etc_gmt_plus_2 : TimeZone
etc_gmt_plus_2 = etc_gmt_plus_2_l

{-| Etc/GMT+3 -}
etc_gmt_plus_3 : TimeZone
etc_gmt_plus_3 = etc_gmt_plus_3_l

{-| Etc/GMT+4 -}
etc_gmt_plus_4 : TimeZone
etc_gmt_plus_4 = etc_gmt_plus_4_l

{-| Etc/GMT+5 -}
etc_gmt_plus_5 : TimeZone
etc_gmt_plus_5 = etc_gmt_plus_5_l

{-| Etc/GMT+6 -}
etc_gmt_plus_6 : TimeZone
etc_gmt_plus_6 = etc_gmt_plus_6_l

{-| Etc/GMT+7 -}
etc_gmt_plus_7 : TimeZone
etc_gmt_plus_7 = etc_gmt_plus_7_l

{-| Etc/GMT+8 -}
etc_gmt_plus_8 : TimeZone
etc_gmt_plus_8 = etc_gmt_plus_8_l

{-| Etc/GMT+9 -}
etc_gmt_plus_9 : TimeZone
etc_gmt_plus_9 = etc_gmt_plus_9_l

{-| Etc/Greenwich -}
etc_greenwich : TimeZone
etc_greenwich = link "Etc/Greenwich" etc_gmt_plus_0_l
...
etc_universal = link "Etc/Universal" etc_utc_l
...
{-| Etc/Zulu -}
etc_zulu : TimeZone
etc_zulu = link "Etc/Zulu" etc_utc_l

{-| Europe/Amsterdam -}
europe_amsterdam : TimeZone
europe_amsterdam = europe_amsterdam_l

{-| Europe/Andorra -}
europe_andorra : TimeZone
europe_andorra = europe_andorra_l

{-| Europe/Astrakhan -}
europe_astrakhan : TimeZone
europe_astrakhan = europe_astrakhan_l

{-| Europe/Athens -}
europe_athens : TimeZone
europe_athens = europe_athens_l

{-| Europe/Belfast -}
europe_belfast : TimeZone
europe_belfast = link "Europe/Belfast" europe_london_l

{-| Europe/Belgrade -}
europe_belgrade : TimeZone
europe_belgrade = europe_belgrade_l

{-| Europe/Berlin -}
europe_berlin : TimeZone
europe_berlin = europe_berlin_l

{-| Europe/Bratislava -}
europe_bratislava : TimeZone
europe_bratislava = link "Europe/Bratislava" europe_prague_l

{-| Europe/Brussels -}
europe_brussels : TimeZone
europe_brussels = europe_brussels_l

{-| Europe/Bucharest -}
europe_bucharest : TimeZone
europe_bucharest = europe_bucharest_l

{-| Europe/Budapest -}
europe_budapest : TimeZone
europe_budapest = europe_budapest_l

{-| Europe/Busingen -}
europe_busingen : TimeZone
europe_busingen = link "Europe/Busingen" europe_zurich_l

{-| Europe/Chisinau -}
europe_chisinau : TimeZone
europe_chisinau = europe_chisinau_l

{-| Europe/Copenhagen -}
europe_copenhagen : TimeZone
europe_copenhagen = europe_copenhagen_l

{-| Europe/Dublin -}
europe_dublin : TimeZone
europe_dublin = europe_dublin_l

{-| Europe/Gibraltar -}
europe_gibraltar : TimeZone
europe_gibraltar = europe_gibraltar_l

{-| Europe/Guernsey -}
europe_guernsey : TimeZone
europe_guernsey = link "Europe/Guernsey" europe_london_l

{-| Europe/Helsinki -}
europe_helsinki : TimeZone
europe_helsinki = europe_helsinki_l

{-| Europe/Isle_of_Man -}
europe_isle_of_man : TimeZone
europe_isle_of_man = link "Europe/Isle_of_Man" europe_london_l

{-| Europe/Istanbul -}
europe_istanbul : TimeZone
europe_istanbul = europe_istanbul_l

{-| Europe/Jersey -}
europe_jersey : TimeZone
europe_jersey = link "Europe/Jersey" europe_london_l

{-| Europe/Kaliningrad -}
europe_kaliningrad : TimeZone
europe_kaliningrad = europe_kaliningrad_l

{-| Europe/Kiev -}
europe_kiev : TimeZone
europe_kiev = europe_kiev_l

{-| Europe/Kirov -}
europe_kirov : TimeZone
europe_kirov = europe_kirov_l

{-| Europe/Lisbon -}
europe_lisbon : TimeZone
europe_lisbon = europe_lisbon_l

{-| Europe/Ljubljana -}
europe_ljubljana : TimeZone
europe_ljubljana = link "Europe/Ljubljana" europe_belgrade_l

{-| Europe/London -}
europe_london : TimeZone
europe_london = europe_london_l

{-| Europe/Luxembourg -}
europe_luxembourg : TimeZone
europe_luxembourg = europe_luxembourg_l

{-| Europe/Madrid -}
europe_madrid : TimeZone
europe_madrid = europe_madrid_l

{-| Europe/Malta -}
europe_malta : TimeZone
europe_malta = europe_malta_l

{-| Europe/Mariehamn -}
europe_mariehamn : TimeZone
europe_mariehamn = link "Europe/Mariehamn" europe_helsinki_l

{-| Europe/Minsk -}
europe_minsk : TimeZone
europe_minsk = europe_minsk_l

{-| Europe/Monaco -}
europe_monaco : TimeZone
europe_monaco = europe_monaco_l

{-| Europe/Moscow -}
europe_moscow : TimeZone
europe_moscow = europe_moscow_l

{-| Europe/Nicosia -}
europe_nicosia : TimeZone
europe_nicosia = link "Europe/Nicosia" asia_nicosia_l

{-| Europe/Oslo -}
europe_oslo : TimeZone
europe_oslo = europe_oslo_l

{-| Europe/Paris -}
europe_paris : TimeZone
europe_paris = europe_paris_l

{-| Europe/Podgorica -}
europe_podgorica : TimeZone
europe_podgorica = link "Europe/Podgorica" europe_belgrade_l

{-| Europe/Prague -}
europe_prague : TimeZone
europe_prague = europe_prague_l

{-| Europe/Riga -}
europe_riga : TimeZone
europe_riga = europe_riga_l

{-| Europe/Rome -}
europe_rome : TimeZone
europe_rome = europe_rome_l

{-| Europe/Samara -}
europe_samara : TimeZone
europe_samara = europe_samara_l

{-| Europe/San_Marino -}
europe_san_marino : TimeZone
europe_san_marino = link "Europe/San_Marino" europe_rome_l

{-| Europe/Sarajevo -}
europe_sarajevo : TimeZone
europe_sarajevo = link "Europe/Sarajevo" europe_belgrade_l

{-| Europe/Simferopol -}
europe_simferopol : TimeZone
europe_simferopol = europe_simferopol_l

{-| Europe/Skopje -}
europe_skopje : TimeZone
europe_skopje = link "Europe/Skopje" europe_belgrade_l

{-| Europe/Sofia -}
europe_sofia : TimeZone
europe_sofia = europe_sofia_l

{-| Europe/Stockholm -}
europe_stockholm : TimeZone
europe_stockholm = europe_stockholm_l

{-| Europe/Tallinn -}
europe_tallinn : TimeZone
europe_tallinn = europe_tallinn_l

{-| Europe/Tirane -}
europe_tirane : TimeZone
europe_tirane = europe_tirane_l

{-| Europe/Tiraspol -}
europe_tiraspol : TimeZone
europe_tiraspol = link "Europe/Tiraspol" europe_chisinau_l

{-| Europe/Ulyanovsk -}
europe_ulyanovsk : TimeZone
europe_ulyanovsk = europe_ulyanovsk_l

{-| Europe/Uzhgorod -}
europe_uzhgorod : TimeZone
europe_uzhgorod = europe_uzhgorod_l

{-| Europe/Vaduz -}
europe_vaduz : TimeZone
europe_vaduz = link "Europe/Vaduz" europe_zurich_l

{-| Europe/Vatican -}
europe_vatican : TimeZone
europe_vatican = link "Europe/Vatican" europe_rome_l

{-| Europe/Vienna -}
europe_vienna : TimeZone
europe_vienna = europe_vienna_l

{-| Europe/Vilnius -}
europe_vilnius : TimeZone
europe_vilnius = europe_vilnius_l

{-| Europe/Volgograd -}
europe_volgograd : TimeZone
europe_volgograd = europe_volgograd_l

{-| Europe/Warsaw -}
europe_warsaw : TimeZone
europe_warsaw = europe_warsaw_l

{-| Europe/Zagreb -}
europe_zagreb : TimeZone
europe_zagreb = link "Europe/Zagreb" europe_belgrade_l

{-| Europe/Zaporozhye -}
europe_zaporozhye : TimeZone
europe_zaporozhye = europe_zaporozhye_l

{-| Europe/Zurich -}
europe_zurich : TimeZone
europe_zurich = europe_zurich_l

{-| GB -}
gb : TimeZone
gb = link "GB" europe_london_l

{-| GB-Eire -}
gb_eire : TimeZone
gb_eire = link "GB-Eire" europe_london_l

{-| GMT -}
gmt : TimeZone
gmt = link "GMT" etc_gmt_plus_0_l

{-| GMT0 -}
gmt_0 : TimeZone
gmt_0 = link "GMT0" etc_gmt_plus_0_l

{-| GMT-0 -}
gmt_minus_0 : TimeZone
gmt_minus_0 = link "GMT-0" etc_gmt_plus_0_l

{-| GMT+0 -}
gmt_plus_0 : TimeZone
gmt_plus_0 = link "GMT+0" etc_gmt_plus_0_l

{-| Greenwich -}
greenwich : TimeZone
greenwich = link "Greenwich" etc_gmt_plus_0_l

{-| Hongkong -}
hongkong : TimeZone
hongkong = link "Hongkong" asia_hong_kong_l
...
{-| Iceland -}
iceland : TimeZone
iceland = link "Iceland" atlantic_reykjavik_l

{-| Indian/Antananarivo -}
indian_antananarivo : TimeZone
indian_antananarivo = link "Indian/Antananarivo" africa_nairobi_l

{-| Indian/Chagos -}
indian_chagos : TimeZone
indian_chagos = indian_chagos_l

{-| Indian/Christmas -}
indian_christmas : TimeZone
indian_christmas = indian_christmas_l

{-| Indian/Cocos -}
indian_cocos : TimeZone
indian_cocos = indian_cocos_l

{-| Indian/Comoro -}
indian_comoro : TimeZone
indian_comoro = link "Indian/Comoro" africa_nairobi_l

{-| Indian/Kerguelen -}
indian_kerguelen : TimeZone
indian_kerguelen = indian_kerguelen_l

{-| Indian/Mahe -}
indian_mahe : TimeZone
indian_mahe = indian_mahe_l

{-| Indian/Maldives -}
indian_maldives : TimeZone
indian_maldives = indian_maldives_l

{-| Indian/Mauritius -}
indian_mauritius : TimeZone
indian_mauritius = indian_mauritius_l

{-| Indian/Mayotte -}
indian_mayotte : TimeZone
indian_mayotte = link "Indian/Mayotte" africa_nairobi_l

{-| Indian/Reunion -}
indian_reunion : TimeZone
indian_reunion = indian_reunion_l

{-| Iran -}
iran : TimeZone
iran = link "Iran" asia_tehran_l

{-| Israel -}
israel : TimeZone
israel = link "Israel" asia_jerusalem_l

{-| Jamaica -}
jamaica : TimeZone
jamaica = link "Jamaica" america_jamaica_l

{-| Japan -}
japan : TimeZone
japan = link "Japan" asia_tokyo_l

{-| Kwajalein -}
kwajalein : TimeZone
kwajalein = link "Kwajalein" pacific_kwajalein_l

{-| Libya -}
libya : TimeZone
libya = link "Libya" africa_tripoli_l
...
mexico_bajanorte = link "Mexico/BajaNorte" america_tijuana_l

{-| Mexico/BajaSur -}
mexico_bajasur : TimeZone
mexico_bajasur = link "Mexico/BajaSur" america_mazatlan_l

{-| Mexico/General -}
mexico_general : TimeZone
mexico_general = link "Mexico/General" america_mexico_city_l
...
{-| Navajo -}
navajo : TimeZone
navajo = link "Navajo" america_denver_l

{-| NZ -}
nz : TimeZone
nz = link "NZ" pacific_auckland_l

{-| NZ-CHAT -}
nz_chat : TimeZone
nz_chat = link "NZ-CHAT" pacific_chatham_l

{-| Pacific/Apia -}
pacific_apia : TimeZone
pacific_apia = pacific_apia_l

{-| Pacific/Auckland -}
pacific_auckland : TimeZone
pacific_auckland = pacific_auckland_l

{-| Pacific/Bougainville -}
pacific_bougainville : TimeZone
pacific_bougainville = pacific_bougainville_l

{-| Pacific/Chatham -}
pacific_chatham : TimeZone
pacific_chatham = pacific_chatham_l

{-| Pacific/Chuuk -}
pacific_chuuk : TimeZone
pacific_chuuk = pacific_chuuk_l

{-| Pacific/Easter -}
pacific_easter : TimeZone
pacific_easter = pacific_easter_l

{-| Pacific/Efate -}
pacific_efate : TimeZone
pacific_efate = pacific_efate_l

{-| Pacific/Enderbury -}
pacific_enderbury : TimeZone
pacific_enderbury = pacific_enderbury_l

{-| Pacific/Fakaofo -}
pacific_fakaofo : TimeZone
pacific_fakaofo = pacific_fakaofo_l

{-| Pacific/Fiji -}
pacific_fiji : TimeZone
pacific_fiji = pacific_fiji_l

{-| Pacific/Funafuti -}
pacific_funafuti : TimeZone
pacific_funafuti = pacific_funafuti_l

{-| Pacific/Galapagos -}
pacific_galapagos : TimeZone
pacific_galapagos = pacific_galapagos_l

{-| Pacific/Gambier -}
pacific_gambier : TimeZone
pacific_gambier = pacific_gambier_l

{-| Pacific/Guadalcanal -}
pacific_guadalcanal : TimeZone
pacific_guadalcanal = pacific_guadalcanal_l

{-| Pacific/Guam -}
pacific_guam : TimeZone
pacific_guam = pacific_guam_l

{-| Pacific/Honolulu -}
pacific_honolulu : TimeZone
pacific_honolulu = pacific_honolulu_l

{-| Pacific/Johnston -}
pacific_johnston : TimeZone
pacific_johnston = link "Pacific/Johnston" pacific_honolulu_l

{-| Pacific/Kiritimati -}
pacific_kiritimati : TimeZone
pacific_kiritimati = pacific_kiritimati_l

{-| Pacific/Kosrae -}
pacific_kosrae : TimeZone
pacific_kosrae = pacific_kosrae_l

{-| Pacific/Kwajalein -}
pacific_kwajalein : TimeZone
pacific_kwajalein = pacific_kwajalein_l

{-| Pacific/Majuro -}
pacific_majuro : TimeZone
pacific_majuro = pacific_majuro_l

{-| Pacific/Marquesas -}
pacific_marquesas : TimeZone
pacific_marquesas = pacific_marquesas_l

{-| Pacific/Midway -}
pacific_midway : TimeZone
pacific_midway = link "Pacific/Midway" pacific_pago_pago_l

{-| Pacific/Nauru -}
pacific_nauru : TimeZone
pacific_nauru = pacific_nauru_l

{-| Pacific/Niue -}
pacific_niue : TimeZone
pacific_niue = pacific_niue_l

{-| Pacific/Norfolk -}
pacific_norfolk : TimeZone
pacific_norfolk = pacific_norfolk_l

{-| Pacific/Noumea -}
pacific_noumea : TimeZone
pacific_noumea = pacific_noumea_l

{-| Pacific/Pago_Pago -}
pacific_pago_pago : TimeZone
pacific_pago_pago = pacific_pago_pago_l

{-| Pacific/Palau -}
pacific_palau : TimeZone
pacific_palau = pacific_palau_l

{-| Pacific/Pitcairn -}
pacific_pitcairn : TimeZone
pacific_pitcairn = pacific_pitcairn_l

{-| Pacific/Pohnpei -}
pacific_pohnpei : TimeZone
pacific_pohnpei = pacific_pohnpei_l

{-| Pacific/Ponape -}
pacific_ponape : TimeZone
pacific_ponape = link "Pacific/Ponape" pacific_pohnpei_l

{-| Pacific/Port_Moresby -}
pacific_port_moresby : TimeZone
pacific_port_moresby = pacific_port_moresby_l

{-| Pacific/Rarotonga -}
pacific_rarotonga : TimeZone
pacific_rarotonga = pacific_rarotonga_l

{-| Pacific/Saipan -}
pacific_saipan : TimeZone
pacific_saipan = link "Pacific/Saipan" pacific_guam_l

{-| Pacific/Samoa -}
pacific_samoa : TimeZone
pacific_samoa = link "Pacific/Samoa" pacific_pago_pago_l

{-| Pacific/Tahiti -}
pacific_tahiti : TimeZone
pacific_tahiti = pacific_tahiti_l

{-| Pacific/Tarawa -}
pacific_tarawa : TimeZone
pacific_tarawa = pacific_tarawa_l

{-| Pacific/Tongatapu -}
pacific_tongatapu : TimeZone
pacific_tongatapu = pacific_tongatapu_l

{-| Pacific/Truk -}
pacific_truk : TimeZone
pacific_truk = link "Pacific/Truk" pacific_chuuk_l

{-| Pacific/Wake -}
pacific_wake : TimeZone
pacific_wake = pacific_wake_l

{-| Pacific/Wallis -}
pacific_wallis : TimeZone
pacific_wallis = pacific_wallis_l

{-| Pacific/Yap -}
pacific_yap : TimeZone
pacific_yap = link "Pacific/Yap" pacific_chuuk_l

{-| Poland -}
poland : TimeZone
poland = link "Poland" europe_warsaw_l

{-| Portugal -}
portugal : TimeZone
portugal = link "Portugal" europe_lisbon_l

{-| PRC -}
prc : TimeZone
prc = link "PRC" asia_shanghai_l
...
{-| ROC -}
roc : TimeZone
roc = link "ROC" asia_taipei_l

{-| ROK -}
rok : TimeZone
rok = link "ROK" asia_seoul_l

{-| Singapore -}
singapore : TimeZone
singapore = link "Singapore" asia_singapore_l

{-| Turkey -}
turkey : TimeZone
turkey = link "Turkey" europe_istanbul_l

{-| UCT -}
uct : TimeZone
uct = link "UCT" etc_uct_l

{-| Universal -}
universal : TimeZone
universal = link "Universal" etc_utc_l

{-| US/Alaska -}
us_alaska : TimeZone
us_alaska = link "US/Alaska" america_anchorage_l

{-| US/Aleutian -}
us_aleutian : TimeZone
us_aleutian = link "US/Aleutian" america_adak_l

{-| US/Arizona -}
us_arizona : TimeZone
us_arizona = link "US/Arizona" america_phoenix_l

{-| US/Central -}
us_central : TimeZone
us_central = link "US/Central" america_chicago_l

{-| US/East-Indiana -}
us_east_indiana : TimeZone
us_east_indiana = link "US/East-Indiana" america_fort_wayne_l

{-| US/Eastern -}
us_eastern : TimeZone
us_eastern = link "US/Eastern" america_new_york_l

{-| US/Hawaii -}
us_hawaii : TimeZone
us_hawaii = link "US/Hawaii" pacific_honolulu_l

{-| US/Indiana-Starke -}
us_indiana_starke : TimeZone
us_indiana_starke = link "US/Indiana-Starke" america_indiana_knox_l

{-| US/Michigan -}
us_michigan : TimeZone
us_michigan = link "US/Michigan" america_detroit_l

{-| US/Mountain -}
us_mountain : TimeZone
us_mountain = link "US/Mountain" america_denver_l

{-| US/Pacific -}
us_pacific : TimeZone
us_pacific = link "US/Pacific" america_los_angeles_l

{-| US/Pacific-New -}
us_pacific_new : TimeZone
us_pacific_new = link "US/Pacific-New" america_los_angeles_l

{-| US/Samoa -}
us_samoa : TimeZone
us_samoa = link "US/Samoa" pacific_pago_pago_l

{-| UTC -}
utc : TimeZone
utc = link "UTC" etc_utc_l

{-| W-SU -}
w_su : TimeZone
w_su = link "W-SU" europe_moscow_l
