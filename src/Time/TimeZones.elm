...
-}
america_punta_arenas : () -> TimeZone
america_punta_arenas () =
    force america_punta_arenas_l
...
asia_singapore () =
    force (link "Asia/Singapore" asia_kuala_lumpur_l)
...
asia_yangon () =
    force (link "Asia/Yangon" asia_rangoon_l)
...
etc_gmt_minus_10 () =
    force (link "Etc/GMT-10" pacific_port_moresby_l)
...
etc_gmt_minus_11 () =
    force (link "Etc/GMT-11" pacific_pohnpei_l)
...
etc_gmt_minus_12 () =
    force (link "Etc/GMT-12" pacific_tarawa_l)
...
etc_gmt_minus_7 () =
    force (link "Etc/GMT-7" indian_christmas_l)
...
etc_gmt_minus_9 () =
    force (link "Etc/GMT-9" pacific_palau_l)
...
etc_gmt_plus_2 () =
    force (link "Etc/GMT+2" atlantic_south_georgia_l)
...
pacific_chuuk () =
    force (link "Pacific/Chuuk" pacific_port_moresby_l)
...
pacific_funafuti () =
    force (link "Pacific/Funafuti" pacific_tarawa_l)
...
pacific_truk () =
    force (link "Pacific/Truk" pacific_port_moresby_l)
...
pacific_wake () =
    force (link "Pacific/Wake" pacific_tarawa_l)
...
pacific_wallis () =
    force (link "Pacific/Wallis" pacific_tarawa_l)
...
pacific_yap () =
    force (link "Pacific/Yap" pacific_port_moresby_l)
...
singapore : () -> TimeZone
singapore () =
    force (link "Singapore" asia_kuala_lumpur_l)
