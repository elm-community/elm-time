...
africa_juba () = force africa_juba_l
...
america_punta_arenas () = force america_punta_arenas_l
...
asia_singapore () = force (link "Asia/Kuala_Lumpur" asia_kuala_lumpur_l)
...
etc_gmt_minus_10 () = force (link "Pacific/Port_Moresby" pacific_port_moresby_l)

{-| Pacific/Pohnpei -}
etc_gmt_minus_11 : () -> TimeZone
etc_gmt_minus_11 () = force (link "Pacific/Pohnpei" pacific_pohnpei_l)

{-| Pacific/Tarawa -}
etc_gmt_minus_12 : () -> TimeZone
etc_gmt_minus_12 () = force (link "Pacific/Tarawa" pacific_tarawa_l)
...
etc_gmt_minus_7 () = force (link "Indian/Christmas" indian_christmas_l)
...
etc_gmt_minus_9 () = force (link "Pacific/Palau" pacific_palau_l)
...
etc_gmt_plus_2 () = force (link "Atlantic/South_Georgia" atlantic_south_georgia_l)
...
pacific_chuuk () = force (link "Pacific/Port_Moresby" pacific_port_moresby_l)
...
pacific_funafuti () = force (link "Pacific/Tarawa" pacific_tarawa_l)
...
pacific_truk () = force (link "Pacific/Port_Moresby" pacific_port_moresby_l)

{-| Pacific/Tarawa -}
pacific_wake : () -> TimeZone
pacific_wake () = force (link "Pacific/Tarawa" pacific_tarawa_l)

{-| Pacific/Tarawa -}
pacific_wallis : () -> TimeZone
pacific_wallis () = force (link "Pacific/Tarawa" pacific_tarawa_l)

{-| Pacific/Port_Moresby -}
pacific_yap : () -> TimeZone
pacific_yap () = force (link "Pacific/Port_Moresby" pacific_port_moresby_l)
...
{-| Asia/Kuala_Lumpur -}
singapore : () -> TimeZone
singapore () = force (link "Asia/Kuala_Lumpur" asia_kuala_lumpur_l)
